<%@ Page Language="C#" MasterPageFile="~/Admin/MasterAdminPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="LogUser.aspx.cs" Inherits="Admin_PageLogUser" Title="Sodevlog - Page des logs" %>
                ...
                <table border="0px" cellpadding="3" cellspacing="2"  bgcolor="#F5F5F4">
                    <tr>
                        <td valign="middle" width="900px">
                            ...
                            &nbsp;
                            <asp:Button ID="ButtonEffacer" runat="server" OnClick="ButtonEffacer_Click" ForeColor="red" Text="Effacer" ToolTip="Effacer tous les logs" />
                            &nbsp;
