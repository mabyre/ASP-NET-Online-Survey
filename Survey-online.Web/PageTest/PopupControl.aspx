...
<table width="100%">
    ...
    <tr>
        ...
        <br />
        <asp:CheckBox ID="CheckBoxQuestionOuverte" runat="server" Text="Autre précisez :" autocomplete="off"/>
        <asp:Panel ID="Panel3" runat="server" CssClass="popupControl">
            <div style="border: 1px outset white; padding-left:150px">
